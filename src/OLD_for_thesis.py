...
from src import data_prep_functions as dpf, plotting_functions as pf, reading_functions as rf, \
    training_functions as trf, plotting_6C_functions as pf6, post_processing_functions as ppf, results as r
import numpy as np
